...
class SMLP(Module):
    ...
    def __init__(self, n_inputs, n_hiddens, n_classes):
        ...
        self.act1 = ReLU()                          # This activation function depends on what you like
...
n_input = 4     # neurons of the input layer
n_hidden = 11   # neurons of the hidden layer
n_class = 4     # neurons of the output layer
